...
# Plot do espaço das verossimelhanças:
{
  ...
  plot(vero_c1, col="black",xlab = "P(x|C_1)", ylab = "P(x|C_2)")
  title("Espaço de Verossimilhanças - Classe 1")
  
  plot( vero_c2, col="red", xlab = "P(x|C_1)", ylab = "P(x|C_2)")
  title("Espaço de Verossimilhanças - Classe 2")
  par(new=T)
